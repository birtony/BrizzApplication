...
import {StyleSheet, View, TouchableWithoutFeedback, Image, DatePickerIOS, SafeAreaView} from 'react-native';
  ...
  render() {
    return (
      <SafeAreaView style={styles.container}>
        ...
        <Input inputContainerStyle={{borderBottomWidth: 0, top: 13}} containerStyle={styles.firstNameInput} />
        <Text h3 style={styles.LNameText}>
          Last Name
        </Text>
        <Input inputContainerStyle={{borderBottomWidth: 0, top: 13}} containerStyle={styles.LNameInput} />
        ...
        <Progress.Bar progress={0.5} width={200} color={'#F28E00'} position={'absolute'} top={'95%'} />
      </SafeAreaView>
    );
  }
}
