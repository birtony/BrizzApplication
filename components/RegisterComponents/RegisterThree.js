  ...
  render() {
    return (
      <SafeAreaView style={styles.container}>
        ...
        <Input inputContainerStyle={{borderBottomWidth: 0, top: 13}} containerStyle={styles.genderInput} disabled />
        ...
        <Input inputContainerStyle={{borderBottomWidth: 0, top: 13}} containerStyle={styles.cityInput} />
