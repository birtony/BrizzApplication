  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={{ top: 20, position: "absolute", fontSize: 60 }}>
          BrIZZ
        </Text>
        <Text
          style={{
        ...
        <Text
          style={{ position: "absolute", top: 430, left: 20, fontSize: 15 }}
        >
          Seneca College
        </Text>
        <Text
        ...
        <Text
          style={{ position: "absolute", top: 490, left: 20, fontSize: 15 }}
        >
          $8000.00 - year
        </Text>
        <Text
        ...
        <Text
          style={{ position: "absolute", top: 550, left: 20, fontSize: 15 }}
        >
          Fall 2020
        </Text>
