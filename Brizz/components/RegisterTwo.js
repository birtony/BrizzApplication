...
import { StyleSheet, View, TouchableWithoutFeedback, Image, DatePickerIOS} from 'react-native';
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <Progress.Bar progress={0.5} width={200} color={'#F28E00'} position={'absolute'} top={810} />
            </View>
        )
    }
}
