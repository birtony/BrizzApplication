...
export const QS_ARTISTIC_CHANGED = 'qs_artistic_changed';
export const QS_CONVENTIONAL_CHANGED = 'qs_conventional_changed';
export const QS_ENTERPRISING_CHANGED = 'qs_enterprising_changed';
export const QS_INVESTIGATIVE_CHANGED = 'qs_investigative_changed';
export const QS_REALISTIC_CHANGED = 'qs_realistic_changed';
export const QS_SOCIAL_CHANGED = 'qs_social_changed';
